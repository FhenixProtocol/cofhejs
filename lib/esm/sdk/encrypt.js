...
import { fromHexString, toBigInt, toBigIntOrThrow, validateBigIntInRange, } from "./utils.js";
import { MAX_UINT8, MAX_UINT16, MAX_UINT32, MAX_UINT64, MAX_UINT128, MAX_UINT256, } from "./consts.js";
/**
...
export const encrypt_uint8 = (value, publicKey, securityZone = 0) => {
    ...
    const encrypted = CompactFheUint8.encrypt_with_compact_public_key(parseInt(bint.toString()), publicKey);
    return {
        data: encrypted.serialize(),
        securityZone,
    };
...
export const encrypt_uint16 = (value, publicKey, securityZone = 0) => {
    ...
    const encrypted = CompactFheUint16.encrypt_with_compact_public_key(parseInt(bint.toString()), publicKey);
    return {
        data: encrypted.serialize(),
        securityZone,
    };
...
export const encrypt_uint32 = (value, publicKey, securityZone = 0) => {
    ...
    const encrypted = CompactFheUint32.encrypt_with_compact_public_key(parseInt(bint.toString()), publicKey);
    return {
        data: encrypted.serialize(),
        securityZone,
    };
...
export const encrypt_uint64 = (value, publicKey, securityZone = 0) => {
    ...
    const encrypted = CompactFheUint64.encrypt_with_compact_public_key(bint, publicKey);
    return {
        data: encrypted.serialize(),
        securityZone,
    };
...
export const encrypt_uint128 = (value, publicKey, securityZone = 0) => {
    ...
    const encrypted = CompactFheUint128.encrypt_with_compact_public_key(bint, publicKey);
    return {
        data: encrypted.serialize(),
        securityZone,
    };
...
export const encrypt_uint256 = (value, publicKey, securityZone = 0) => {
    ...
    const encrypted = CompactFheUint256.encrypt_with_compact_public_key(bint, publicKey);
    return {
        data: encrypted.serialize(),
        securityZone,
    };
